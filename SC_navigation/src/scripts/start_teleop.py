...
import rospy
from SC_navigation.teleop_controller import Controller
...
if __name__ == '__main__':
    ...
    try:
        ...
        if mode=='train':
            ...
            is_training=False
        hyper_param = HyperParams(rospy.get_param('/training'),is_training) 
        
        
        rospy.init_node('navigation_controller', anonymous=True,disable_signals=True)
        node =Controller(mode=mode,hyper_param=hyper_param,rate=rate,verbose=verbose)
